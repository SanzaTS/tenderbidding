...
if(isset($_POST['send']))
{
   ...
   // echo $email." ".$reciever." ".$msg." ".$date." ".$time;
    $sqlChat =  "INSERT INTO `chat`( `sender`, `reciever`, `Msg`, `date`, `time`) VALUES ('$username','$reciever','$msg','$date','$time')";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form role="form" id="formLogin" novalidate="" method="POST" action="adminChat.php">
