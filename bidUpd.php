...
if(isset($_POST['save'])){
  ...
  $min = "";
   ...
   while($row1 = mysqli_fetch_array($res1))
   {
    ...
    if($amount <= $min)
    {
       //$error = "amount must be higher then Highest bid amount";
        //header("location:bidUpd.php?id=$ref");
      // 
      ?>
      <script>
     alert('amount must be higher then Highest bid amount');
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
     ...
     <form role="form" id="formLogin" novalidate="" method="POST" action="bidUpd.php">
     ...
     <div class="form-group">
               <label>Update  Bid</label>
                <input class="form-control"  maxlength="12" name="minimum" id="minimum" placeholder="Update Bid" >
              </div>
     <button type="submit" class="btn btn-success"  name="save"id="save"> Bid</button>
          <br>
          <a style="margin-left:250;" href="allbids.php">Back To bids<a>
     <form>
